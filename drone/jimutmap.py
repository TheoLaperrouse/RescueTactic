...
class api:
    ...
    """
    def __init__(self, min_lat_deg:float, max_lat_deg:float, min_lon_deg:float, max_lon_deg:float, zoom= 19, ac_key:str= None, verbose:bool= False, threads_:int= 8, container_dir:str= "", idImage:str=""):
        """
        Parameters
        -------------------------------------
    ...
    def get_img(self, url_str:str, vNumber:int= 9042, getMask:bool= None, prefix:str= "", _rerun:bool= False):
        ...
        xTile = url_str[0]
        yTile = url_str[1]
        file_name = join(self.container_dir, self.idImage)
        try:
